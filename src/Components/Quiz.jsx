...
function Quiz({ studentEmail }) {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://grader-final-2.onrender.com/quiz/start", { params: { email: studentEmail } })
      .then((response) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values, { setSubmitting }) => {
      ...
      axios
        .post(`https://grader-final-2.onrender.com/quiz/submit?email=${studentEmail}`, answers)
        .then(() => {
          setSubmitted(true);
  ...
  const fetchScore = () => {
    ...
    axios
      .get(`https://grader-final-2.onrender.com/students/score`, { params: { email: studentEmail } })
      .then((res) => {
        setScore(res.data);
      })
      .catch((err) => {
